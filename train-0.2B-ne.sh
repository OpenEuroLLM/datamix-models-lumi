...
# - elapsed time per iteration (ms): ~1900
# - throughput per GPU (TFLOP/s/GPU): ~50
# - Tokens per second per GPU (Tok/s/GPU): ~17500
# - Time to 100BT: ~26h
# - Total GPUh to 100BT: ~832 MI250X-hours
...
WANDB_EXP_NAME="0.2B-ne-openeurollm-256k"
