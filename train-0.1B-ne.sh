...
# With --nodes 8 on LUMI
# - elapsed time per iteration (ms): ~1300
# - throughput per GPU (TFLOP/s/GPU): ~40
# - Tokens per second per GPU (Tok/s/GPU): ~24500
# - Time to 100BT: ~18h
# - Total GPUh to 100BT: ~576 MI250X-hours
...
# Megatron-LM base directory. Tested on LUMI with
# https://github.com/OpenEuroLLM/NVIDIA-Megatron-LM/commit/055f7de
...
WANDB_EXP_NAME="0.1B-ne-openeurollm-256k"
...
# DATA
DATA_PATH="/scratch/project_462000963/preprocessed/oellm-v1-256k/catalogue/nemotron-cc/1.0/20p-sample/high-actual-20p"
