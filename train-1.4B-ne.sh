...
# - elapsed time per iteration (ms): ~3100
# - throughput per GPU (TFLOP/s/GPU): ~70
# - Tokens per second per GPU (Tok/s/GPU): ~5300
# - Time to 100BT: ~42h
# - Total GPUh to 100BT: ~2688 MI250X-hours
...
WANDB_EXP_NAME="1.4B-ne-openeurollm-256k"
