...
# - elapsed time per iteration (ms): ~2500
# - throughput per GPU (TFLOP/s/GPU): ~60
# - Tokens per second per GPU (Tok/s/GPU): ~6600
# - Time to 100BT: ~34h
# - Total GPUh to 100BT: ~2176 MI250X-hours
...
WANDB_EXP_NAME="0.9B-ne-openeurollm-256k"
